...
//import Compnents
import PaymentCheckboxes from './PaymetCheckboxes'
import AmountDonationsTextFileds from './AmountDonations'
    ...
    return (
     <div style={{backgroundColor: 'rgba(0, 0, 0, 0.09)'}}>
        ...
        <Divider classes={{root: classes.divider}}  variant='middle'/>                   
            <PageBeardCrumbs />
          <Grid item>
            <AmountDonationsTextFileds updateAmount ={(data)=>{setDonationAmount(data)}}/>
          </Grid>
           <Grid item xs={12}>
                <PaymentCheckboxes updateDonationType={(data)=>{changeDonationType(data)}}
